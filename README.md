...
- ✅ Синхронизация закладок и истории через Google Drive (app-data folder)
...
Закладки и история кладутся одним JSON-документом в **app-data folder** вашего
Google Диска — это скрытое хранилище приложения, область `drive.appdata`. Больше
браузер не просит ничего: с этой областью он физически не может увидеть ни один
ваш файл на Диске. Своего сервера в схеме нет.
